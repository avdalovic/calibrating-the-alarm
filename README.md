...
3. `results/gamma_sensitivity/`
4. `results/layers_robustness/`
5. `results/degraded_feedback/`
...
The gamma sweep treats `gamma` as the ACI operator-feedback learning rate and shows stable recall with a gradual FPR/F1 tradeoff across step sizes.
